...
var CommentArea = React.createClass({displayName: "CommentArea",
	render: function(){
		return (React.createElement("div", null, " This the comment area "));
	}
});

var ExpandoButton = React.createClass({displayName: "ExpandoButton",
	render: function(){
		return (React.createElement("div", null, " This is the button "));
	}
});

var CommentsController = React.createClass({displayName: "CommentsController",
	render: function(){
		return (React.createElement("div", null, " This is the controller", 
					React.createElement(ExpandoButton, null), 
...
React.render(
	React.createElement(CommentsController, null),
